...
namespace VulkanTutorial
{
    public unsafe class HelloTriangle : MainWindow
    {
        ...
        private Semaphore[] _imageAvailableSemaphores = new Semaphore[MaxFramesInFlight];
        private Semaphore[] _renderFinishedSemaphores = new Semaphore[MaxFramesInFlight];
